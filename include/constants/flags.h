...
#define FLAG_HIDE_ROUTE_104_RIVAL                                   0x2CF //Barry ver Lake
...
#define FLAG_HIDE_ROUTE_103_RIVAL                                   0x2D3 //Barry Route 201 First
...
#define FLAG_HIDE_PETALBURG_CITY_WALLYS_MOM                         0x2D8 //Cyrus at ver lake
...
#define FLAG_JUBILIFE_POKETKCH                                      0x493 // Poketech Guy
...
#define FLAG_CLOWNS                                 (SYSTEM_FLAGS + 0x85) // Used for the two clowns that appear after the school event
#define FLAG_JUBILIFE_LOOKER_BLOCK                  (SYSTEM_FLAGS + 0x86) // USed for locker blocking you in jubilife

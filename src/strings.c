...
const u8 gText_BirchInTrouble[] = _("Now choose!\nWhich Pokémon will it be?");
...
const u8 gText_MenuPokenav[] = _("Pokétch");
...
const u8 gText_DexHoenn[] = _("Sinnoh");
...
const u8 gText_SubQuest1_Desc1[] = _("Catch 30 Pokémon");
const u8 gText_SubQuest1_Desc2[] = _("Catch 50 Pokémon");
const u8 gText_SubQuest1_Desc3[] = _("Catch 80 Pokémon");
const u8 gText_SubQuest1_Desc4[] = _("Catch 100 Pokémon");

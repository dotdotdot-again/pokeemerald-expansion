...
const u16 gTilesetAnims_PorytilesPrimaryPlatGBA_Water_Mid_Frame2[] = INCBIN_U16("data/tilesets/primary/porytiles_primary_plat_gba/anim/water_middle/02.4bpp");
const u16 gTilesetAnims_PorytilesPrimaryPlatGBA_Water_Mid_Frame3[] = INCBIN_U16("data/tilesets/primary/porytiles_primary_plat_gba/anim/water_middle/03.4bpp");
const u16 gTilesetAnims_PorytilesPrimaryPlatGBA_Water_Mid_Frame4[] = INCBIN_U16("data/tilesets/primary/porytiles_primary_plat_gba/anim/water_middle/04.4bpp");
...
const u16 *const gTilesetAnims_PorytilesPrimaryPlatGBA_Water_Mid[] = {
    gTilesetAnims_PorytilesPrimaryPlatGBA_Water_Mid_Frame0,
    gTilesetAnims_PorytilesPrimaryPlatGBA_Water_Mid_Frame1,
    gTilesetAnims_PorytilesPrimaryPlatGBA_Water_Mid_Frame2,
    gTilesetAnims_PorytilesPrimaryPlatGBA_Water_Mid_Frame3,
    gTilesetAnims_PorytilesPrimaryPlatGBA_Water_Mid_Frame4,
    gTilesetAnims_PorytilesPrimaryPlatGBA_Water_Mid_Frame5,
    gTilesetAnims_PorytilesPrimaryPlatGBA_Water_Mid_Frame6,
    gTilesetAnims_PorytilesPrimaryPlatGBA_Water_Mid_Frame7,
...
{
    if (timer % 16 == 0) {
        QueueAnimTiles_PorytilesPrimaryPlatGBA_Water_Mid(timer / 16);
    }

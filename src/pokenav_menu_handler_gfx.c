...
static const u16 sOptionsLabelGfx_Condition[] = {0x020, PALTAG_OPTIONS_DEFAULT - PALTAG_OPTIONS_START};
...
static const u16 sOptionsLabelGfx_SwitchOff[] = {0x080, PALTAG_OPTIONS_DEFAULT - PALTAG_OPTIONS_START};
...
{
    [POKENAV_MENUITEM_MAP]                     = COMPOUND_STRING("Check the map of the Sinnoh region"),
    ...
    [POKENAV_MENUITEM_SWITCH_OFF]              = COMPOUND_STRING("Put away the Pokétch."),
    ...
    [POKENAV_MENUITEM_CONDITION_CANCEL]        = COMPOUND_STRING("Return to the Pokétch menu."),
